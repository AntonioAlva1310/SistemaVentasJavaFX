...
public class Conexion {
    public final String PERSISTENCE_UNIT_NAME = "VentasPU";
    ...
    public Conexion(){
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("no se creo conexion");
        }
    }
    public static Conexion getInstancia(){
        ...
        public void update (Object elemento){
         ...
         public List<?> findAll(Class<?> clase){
             ...
             .substring(clase.getTypeName().lastIndexOf(".")+1,
                                     clase.getTypeName()
